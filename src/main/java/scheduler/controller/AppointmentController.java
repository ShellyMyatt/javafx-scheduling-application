...
public class AppointmentController implements Initializable {
    ...
    public void reportsButton(ActionEvent actionEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/scheduler/ReportsScreen.fxml"));
    ...
    public void addAppointmentButton(ActionEvent actionEvent) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/scheduler/AddAppointmentScreen.fxml"));
        Stage stage = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        Scene scene = new Scene(root);
    ...
    public void modifyAppointmentButton(ActionEvent actionEvent) throws IOException {
        ...
        if (selectModifyAppointment == null) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/scheduler/ModifyAppointmentScreen.fxml"));
